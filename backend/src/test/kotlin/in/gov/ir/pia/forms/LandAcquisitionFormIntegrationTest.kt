...
class LandAcquisitionFormIntegrationTest {
    ...
    companion object {
        ...
        val EXPECTED_SECTION_CODES = listOf(
    ...
    private fun headersFor(cookies: List<String>, extra: Map<String, String> = emptyMap()): HttpHeaders {
        val h = HttpHeaders()
    ...
    fun `creating a Land Acquisition record creates 9 section workflow instances`() {
        ...
        val instanceCount = jdbc.queryForObject(
            """
        ...
        val sectionCodes = jdbc.queryForList(
            """
        ...
        val draftCount = jdbc.queryForObject(
            """
            SELECT count(*) FROM workflow_instances wi
